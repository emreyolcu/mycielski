...
void App::catch_alarm () {
  ...
  // of asynchronous termination is used with the library.
#if 0
  // Immediate asynchronous call into solver:
  solver->terminate ();
#else
  // Wait for solver to call 'App::terminate ()'.
  timesup = true;
#endif
}
